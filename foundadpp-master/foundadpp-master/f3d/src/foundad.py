...
class VisionModule(nn.Module):
    ...
    def _build_encoder(self, model: str):
        ...
        if model == "dinov2":
            ...
            enc = torch.hub.load("facebookresearch/dinov3", 'dinov3_vitb16', source="local", weights="/tmp/facebookresearch/dinov3/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth").eval()
            num_patches, embed_dim = enc.patch_embed.num_patches, enc.embed_dim
        elif model == "dino":
